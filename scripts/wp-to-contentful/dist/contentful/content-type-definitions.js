...
exports.makeContentTypePayload = exports.contentTypeDefinitions = void 0;
const makeWpIdField = () => ({
    id: "wpId",
    name: "wpId",
    type: "Integer",
...
exports.contentTypeDefinitions = {
    wpAuthor: {
        name: "Author",
        displayField: "name",
        fields: [
...
const makeContentTypePayload = (definition) => ({
    name: definition.name,
    displayField: definition.displayField,
    fields: definition.fields,
});
exports.makeContentTypePayload = makeContentTypePayload;
